...
### [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} package features {style="color:white;"}

### [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} models and identification{style="color:white;"}

### [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} modeling of monetary policy{style="color:white;"}
...
### Slides [as a Website](https://bsvars.github.io/2024-08-bsvars-w4UKR/){style="color:#8c52ff;"} {style="color:white;"}

### GitHub [repo](https://github.com/bsvars/2024-08-bsvars-w4UKR){style="color:#8c52ff;"} to reproduce the slides and results {style="color:white;"}

### [**R** script](https://github.com/bsvars/2024-08-bsvars-w4UKR/blob/main/w4UKR_empirical.R){style="color:#8c52ff;"} to reproduce empirical results {style="color:white;"}


## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} package features {background-color="#00bf63"}
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} package features
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} models and identification {background-color="#00bf63"}




## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} models
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} identification (simplified)
...
- $\mathbf{B}_0$ is <text style="color:#00bf63;">**not identified**</text>
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} identification (simplified) {background-color="#00bf63"}
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} identification verification
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} hypothesis verification
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} modeling of monetary policy   {background-color="#00bf63"}
...
## [bsvars](https://cran.r-project.org/package=bsvars){style="color:#8c52ff;"} modeling of monetary policy
...
<!-- <!-- post |> forecast(horizon = 24) |> plot(probability = 0.68, col = "#00bf63") --> -->
<!-- <!-- ``` --> -->
...
<!-- ```{r bs01df} -->
<!-- #| cache: true -->
<!-- post$posterior$df |> hist(breaks = 100, col = "#00bf63", border = "#00bf63", bty = "n" ) -->
<!-- ``` -->
